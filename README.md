...
[godev]: https://pkg.go.dev/github.com/kellen-miller/franz-go/pkg/kgo
...
[KADMC]: https://pkg.go.dev/github.com/kellen-miller/franz-go/pkg/kadm
[SRC]: https://pkg.go.dev/github.com/kellen-miller/franz-go/pkg/sr
...
The main client is located in the package `github.com/kellen-miller/franz-go/pkg/kgo`,
while the root of the project is at `github.com/kellen-miller/franz-go`. There are
a few extra packages within the project, as well as a few sub-modules. To
use the main kgo package,

```
go get github.com/kellen-miller/franz-go
```

To use a plugin,

```
go get github.com/kellen-miller/franz-go/plugin/kzap
```

To use kadm,

```
go get github.com/kellen-miller/franz-go/pkg/kadm
```
...
```
require (
	github.com/kellen-miller/franz-go v1.12.0
	github.com/kellen-miller/franz-go/pkg/kmsg v1.4.0
)
```
...
or comment on [#142](https://github.com/kellen-miller/franz-go/issues/142)!
...
modules, e.g. `github.com/kellen-miller/franz-go/plugin/kprom@v1.0.0`.
